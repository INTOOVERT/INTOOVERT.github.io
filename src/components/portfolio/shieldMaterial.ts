...
/** Force-shield GLSL adapted from cortiz2894/flow-shield-effect (MIT). */
...
export function createShieldMaterial(color: string): THREE.ShaderMaterial {
